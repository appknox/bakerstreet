...
func (c *moriartyClient) StartAutoPilot(ctx context.Context, in *AutoPilotConfig, opts ...grpc.CallOption) (*Message, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Message)
	err := c.cc.Invoke(ctx, Moriarty_StartAutoPilot_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedMoriartyServer must be embedded to have
...
func (UnimplementedMoriartyServer) testEmbeddedByValue()                  {}
...
func RegisterMoriartyServer(s grpc.ServiceRegistrar, srv MoriartyServer) {
	// If the following call panics, it indicates UnimplementedMoriartyServer was
